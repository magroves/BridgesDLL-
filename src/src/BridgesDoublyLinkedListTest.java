...
public class BridgesDoublyLinkedListTest {
	...
	public final void testRemove1a() {
		populateList();
		assertEquals("Will", list.remove(1).getValue());
	}
	...
	public final void testRemove2() {
		populateList();
		assertEquals("Eleven", list.remove(5).getValue());
	}
	...
	public final void testRemove3a() {
		populateList();
		assertEquals("Lucas", list.remove(3).getValue());
	}
	...
	public final void testReplace1() {
		...
		assertEquals(list.getEntry(6).getValue(), "Nothing");
	}
	...
	public final void testGetEntry1() {
		populateList();
		assertEquals(list.getEntry(2).getValue(), "Dustin");
	}
	...
	public final void testGetEntry2() {
		populateList();
		assertEquals(list.getEntry(5).getValue(), "Eleven");
	}
	...
	public final void testGetEntry3() {
		populateList();
		assertEquals(list.getEntry(6).getValue(), "Eleven");
	}
	...
	public final void testGetEntry4() {
		populateList();
		assertEquals(list.getEntry(0).getValue(), "Dustin");
	}
